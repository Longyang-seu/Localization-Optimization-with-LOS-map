...
if __name__ == "__main__":
    ...
    for NT in range(80,112,16):
        ...
        beam_SPEB_NT[0,int(NT/16)-5]=beam_SPEB_map/9
        beam_SPEB_NT[1,int(NT/16)-5]=beam_SPEB_dis/9
    pkl.dump(beam_SPEB_NT,open("beam_SPEB_NT_more1.pkl","wb"))